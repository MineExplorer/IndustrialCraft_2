...
var noDropBlocks = [6, 26, 30, 31, 32, 51, 59, 92, 99, 100, 104, 105, 106, 115, 127, 132, 141, 142, 161, 175, 244, 385, 386, 388, 389, 390, 391, 392, 462];
...
var ToolLib = {
	...
	getBlockDrop: function(coords, id, data, level, enchant){
		...
		if(id == 5 || id == 6 || id == 19 || id == 35 || id == 85 || id == 144 || id == 158 || id == 171 || id == 467) return [[id, 1, data]];
		...
		if(id == 89) return [[348, random(2, 4)]]; // glowstone
		if(id == 93 || id == 94) return [[356, 1, 0]]; // repeater
		if(id == 103) return [[360, random(3, 7)]]; // melon
		...
		if(id == 199) return [[389, 1, 0]]; // item frame
		// doors
