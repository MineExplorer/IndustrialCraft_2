...
(function (MachineRegistry) {
    ...
    MachineRegistry.setFacing = setFacing;
...
var TileEntityElectricMachine = /** @class */ (function (_super) {
    ...
    function TileEntityElectricMachine() {
        var _this = _super.call(this) || this;
        // setup energy values
        if (_this.defaultValues) {
            _this.defaultValues.energy = 0;
            _this.defaultValues.energy_receive = 0;
            _this.defaultValues.last_energy_receive = 0;
            _this.defaultValues.voltage = 0;
            _this.defaultValues.last_voltage = 0;
        }
        else {
            _this.defaultValues = {
                energy: 0,
...
MachineRegistry.registerPrototype(BlockID.nuke, {
    ...
    explode: function (radius) {
        ...
        var entities = Entity.getAll();
        var rad = radius * 1.5;
        for (var i_10 in entities) {
            var ent = entities[i_10];
...
Callback.addCallback("PreLoaded", function () {
    function isToolboxEmpty(slot) {
        ...
        if (container) {
            for (var i_12 = 1; i_12 <= 10; i_12++) {
                if (container.getSlot("slot" + i_12).id != 0) {
                    return false;
                }
            }
        }
...
var ReactorAPI = {
    ...
    fuelRod: function (cells, durability, depleted) {
        ...
        this.processChamber = function (item, reactor, x, y, heatRun) {
            ...
            for (var i_22 = 0; i_22 < this.numberOfCells; i_22++) {
                var dheat = 0;
                var pulses = basePulses;
                if (!heatRun) {
                    for (var i_23 = 0; i_23 < pulses; i_23++) {
    ...
    heatExchanger: function (heatStorage, switchSide, switchReactor) {
        ...
        this.processChamber = function (item, reactor, x, y, heatrun) {
            ...
            if (this.switchSide > 0) {
                ...
                this.checkHeatAcceptor(reactor, x, y - 1, heatAcceptors);
                this.checkHeatAcceptor(reactor, x, y + 1, heatAcceptors);
                for (var i_24 in heatAcceptors) {
                    var acceptor = heatAcceptors[i_24];
...
for (var i_25 = 0; i_25 < 15; i_25++) {
    var x = i_25 % 5;
    var y = Math.floor(i_25 / 5) + 1;
    cropHarvesterGuiObject.elements["outSlot" + i_25] = { type: "slot", x: 520 + x * 60, y: 50 + y * 60 };
}
;
...
for (var i_27 = 1; i_27 < 7; i_27++) {
    newGuiMatronObject.elements["slotWeedEx" + i_27] = { type: "slot", x: 441 + 60 * i_27, y: 155, isValid: isWeedEx };
}
for (var i_28 = 1; i_28 < 7; i_28++) {
    newGuiMatronObject.elements["slotFertilizer" + i_28] = { type: "slot", x: 441 + 60 * i_28, y: 75, isValid: isFertilizer };
}
...
MachineRegistry.registerElectricMachine(BlockID.cropMatron, {
    ...
    getSlot: function (type) {
        for (var i_29 = 0; i_29 < 7; i_29++) {
            var slot = this.container.getSlot(type + i_29);
            if (slot.id)
                return slot;
        }
        return null;
...
var TileEntityTransformer = /** @class */ (function (_super) {
    ...
    TileEntityTransformer.prototype.getTier = function () {
        return this.tier;
    };
    ...
    TileEntityTransformer.prototype.click = function (id, count, data, coords) {
        var item = Player.getCarriedItem();
    ...
    TileEntityTransformer.prototype.wrenchClick = function (id, count, data, coords) {
        if (this.setFacing(coords.side)) {
            EnergyNetBuilder.rebuildTileNet(this);
            return true;
        }
    ...
    TileEntityTransformer.prototype.renderModel = function () {
        TileRenderer.mapAtCoords(this.x, this.y, this.z, this.blockID, this.data.meta);
    };
...
var TileEntityTransformerEV = /** @class */ (function (_super) {
    __extends(TileEntityTransformerEV, _super);
    function TileEntityTransformerEV() {
        return _super.call(this, 5) || this;
    }
    return TileEntityTransformerEV;
}(TileEntityTransformer));
MachineRegistry.registerPrototype(BlockID.transformerEV, TileEntityTransformerEV);
/// <reference path="./TileEntityTransformer.ts" />
...
var TileEntityTransformerHV = /** @class */ (function (_super) {
    __extends(TileEntityTransformerHV, _super);
    function TileEntityTransformerHV() {
        return _super.call(this, 4) || this;
    }
    return TileEntityTransformerHV;
}(TileEntityTransformer));
MachineRegistry.registerPrototype(BlockID.transformerEV, TileEntityTransformerHV);
/// <reference path="./TileEntityTransformer.ts" />
...
var TileEntityTransformerLV = /** @class */ (function (_super) {
    __extends(TileEntityTransformerLV, _super);
    function TileEntityTransformerLV() {
        return _super.call(this, 2) || this;
    }
    return TileEntityTransformerLV;
}(TileEntityTransformer));
MachineRegistry.registerPrototype(BlockID.transformerEV, TileEntityTransformerLV);
/// <reference path="./TileEntityTransformer.ts" />
...
var TileEntityTransformerMV = /** @class */ (function (_super) {
    __extends(TileEntityTransformerMV, _super);
    function TileEntityTransformerMV() {
        return _super.call(this, 3) || this;
    }
    return TileEntityTransformerMV;
}(TileEntityTransformer));
MachineRegistry.registerPrototype(BlockID.transformerEV, TileEntityTransformerMV);
...
var ItemArmorNanoSuit = /** @class */ (function (_super) {
    ...
    ItemArmorNanoSuit.prototype.onTick = function (slot, index) {
        var energyStored = ChargeItemRegistry.getEnergyStored(slot);
...
ToolType.drill = {
    ...
    useItem: function (coords, item, block) {
        ...
        for (var i_31 = 9; i_31 < 45; i_31++) {
            var slot = Player.getInventorySlot(i_31);
            if (slot.id == 50) {
                ...
                if (slot.count == 0)
                    slot.id = 0;
                Player.setInventorySlot(i_31, slot.id, slot.count, 0);
                break;
            }
        }
    },
...
var NanoSaber = {
    ...
    tick: function () {
        if (World.getThreadTime() % 20 == 0) {
            for (var i_32 = 0; i_32 < 36; i_32++) {
                var item = Player.getInventorySlot(i_32);
                if (item.id == ItemID.nanoSaberActive) {
                    ...
                    ChargeItemRegistry.setEnergyStored(item, energyStored);
                    Player.setInventorySlot(i_32, item.id, 1, item.data, item.extra);
                }
            }
        }
    }
...
for (var i_33 = 1; i_33 <= 16; i_33++) {
    IDRegistry.genItemID("icPainter" + i_33);
    Item.createItem("icPainter" + i_33, colorNames[i_33 - 1] + " Painter", { name: "ic_painter", meta: i_33 }, { stack: 1 });
    Item.setMaxDamage(ItemID["icPainter" + i_33], 16);
    painterCreativeGroup.push(ItemID["icPainter" + i_33]);
}
...
for (var i_34 = 6; i_34 <= 15; i_34++) {
    Recipes.addShapeless({ id: ItemID["icPainter" + i_34], count: 1, data: 0 }, [{ id: ItemID.icPainter, data: 0 }, { id: 351, data: i_34 - 1 }]);
}
Recipes.addShapeless({ id: ItemID.icPainter16, count: 1, data: 0 }, [{ id: ItemID.icPainter, data: 0 }, { id: 351, data: 19 }]);
var _loop_2 = function (i_35) {
    var index = i_35 - 1;
    Item.registerUseFunction("icPainter" + i_35, function (pos, item, block) {
