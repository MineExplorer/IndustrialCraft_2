...
Item.createItem("fuelRodUranium", "Fuel Rod (Uranium)", {name: "fuel_rod_uranium", meta: 0}, {stack: 1});
Item.createItem("fuelRodUranium2", "Dual Fuel Rod (Uranium)", {name: "fuel_rod_uranium", meta: 1}, {stack: 1});
Item.createItem("fuelRodUranium4", "Quad Fuel Rod (Uranium)", {name: "fuel_rod_uranium", meta: 2}, {stack: 1});
...
RadiationAPI.regRadioactiveItem(ItemID.fuelRodUranium, 60);
RadiationAPI.regRadioactiveItem(ItemID.fuelRodUranium2, 60);
RadiationAPI.regRadioactiveItem(ItemID.fuelRodUranium2, 60);

IDRegistry.genItemID("fuelRodMOX");
IDRegistry.genItemID("fuelRodMOX2");
IDRegistry.genItemID("fuelRodMOX4");
Item.createItem("fuelRodMOX", "Fuel Rod (MOX)", {name: "fuel_rod_mox", meta: 0}, {stack: 1});
Item.createItem("fuelRodMOX2", "Dual Fuel Rod (MOX)", {name: "fuel_rod_mox", meta: 1}, {stack: 1});
Item.createItem("fuelRodMOX4", "Quad Fuel Rod (MOX)", {name: "fuel_rod_mox", meta: 2}, {stack: 1});
...
RadiationAPI.regRadioactiveItem(ItemID.fuelRodMOX, 300);
RadiationAPI.regRadioactiveItem(ItemID.fuelRodMOX2, 300);
RadiationAPI.regRadioactiveItem(ItemID.fuelRodMOX4, 300);
