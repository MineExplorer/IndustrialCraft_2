...
AgricultureAPI.registerCropCard({
    ...
    getSeed:function(){
        return {id:361,count:random(0,3)+1,data:0}
    },
...
AgricultureAPI.registerCropCard({
    ...
    getProduct:function(){
        ...
        return {id:360,count:random(0,4)+2,data:0}
    },
    getGrowthDuration(te) {
        if (te.currentSize == 3) {
            return 700;
    ...
    getSeed:function(){
        return {id:362,count:random(0,2)+1,data:0}
    }
});
...
AgricultureAPI.registerCropCard({
    ...
    getSizeAfterHarvest:function(crop) {
        if (crop.data.currentSize == 4) {return Math.round(3 - random(0,3))}
        return 1;
    },
    onEntityCollision(crop){return false},
...
AgricultureAPI.registerCropCard({
    ...
    tick:function(te){
        if(te.isBlockBelow(88)){
            ...
            }else if(te.isBlockBelow(80)&&random(0,300)==1){
...
AgricultureAPI.registerCropCard({
    ...
    tick:function(te){
        if(te.isBlockBelow(80)){
            if (te.crop.canGrow(te)) {
                te.data.growthPoints+=100
            }else if(te.isBlockBelow(88)&&random(0,300)==1){
...
AgricultureAPI.registerCropCard({
    ...
    getGain(crop) {
        if (random(0,1))return {id:331,count:1,data:0};
        return {id:295,count:1,data:0}
    },
...
AgricultureAPI.registerCropCard({
    ...
    getGain(crop) {
        if (crop.data.currentSize >= 4 && random(0,20) == 1) {
