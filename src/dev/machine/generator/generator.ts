/// <reference path="../TileEntityGenerator.ts" />
...
class TileEntityFuelGenerator extends TileEntityGenerator {
	constructor() {
		super(1);
	}
...
MachineRegistry.registerPrototype(BlockID.primalGenerator, new TileEntityFuelGenerator());
