/// <reference path="TileEntityHeatGenerator.ts" />
...
class TileEntityFluidHeatGenerator
extends TileEntityHeatGenerator {
	defaultValues: {
		meta: 0,
		output: 0,
		fuel: 0,
...
MachineRegistry.registerPrototype(BlockID.fluidHeatGenerator, new TileEntityFluidHeatGenerator());
