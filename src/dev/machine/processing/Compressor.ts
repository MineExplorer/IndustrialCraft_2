...
Callback.addCallback("PreLoaded", function() {
	...
	MachineRecipeRegistry.registerRecipes<ItemProcessingRecipe>("compressor", [
		...
		{ source: {id: VanillaItemID.clay_ball, count: 4}, result: [{id: VanillaBlockID.clay, count: 1}] },
		{ source: {id: VanillaItemID.brick, count: 4}, result: [{id: 45, count: 1}] },
		{ source: {id: VanillaItemID.netherbrick, count: 4}, result: [{id: 112, count: 1}] },
		{ source: {id: VanillaItemID.glowstone_dust, count: 4}, result: [{id: 89, count: 1}] },
		{ source: {id: VanillaItemID.quartz, count: 4}, result: [{id: 155, count: 1, data: 0}] },
		{ source: {id: VanillaItemID.snowball}, result: [{id: VanillaBlockID.snow, count: 1}] },
		{ source: {id: VanillaBlockID.snow}, result: [{id: 79, count: 1}] },
		{ source: {id: VanillaBlockID.ice, count: 9}, result: [{id: VanillaBlockID.packed_ice, count: 1}] },
		{ source: {id: VanillaBlockID.packed_ice, count: 9}, result: [{id: VanillaBlockID.blue_ice, count: 1}] },
		{ source: {id: VanillaItemID.bone_meal, count: 9}, result: [{id: VanillaBlockID.bone_block, count: 1}] },
		{ source: {id: VanillaItemID.dried_kelp, count: 9}, result: [{id: VanillaBlockID.dried_kelp_block, count: 1}] },
		...
		{ source: {id: ItemID.ingotAlloy}, result: [{id: ItemID.plateAlloy, count: 1}] },
		{ source: {id: ItemID.carbonMesh}, result: [{id: ItemID.carbonPlate, count: 1}] },
		{ source: {id: ItemID.coalBall}, result: [{id: ItemID.coalBlock, count: 1}] },
		{ source: {id: ItemID.coalChunk}, result: [{id: 264, count: 1}] },
		{ source: {id: ItemID.cellEmpty}, result: [{id: ItemID.cellAir, count: 1}] },
		{ source: {id: ItemID.dustLapis}, result: [{id: ItemID.plateLapis, count: 1}] },
		{ source: {id: VanillaItemID.blaze_powder, count: 5}, result: [{id: VanillaItemID.blaze_rod, count: 1}] },

		// Dense Plates
		{ source: {id: ItemID.plateIron, count: 9}, result: [{id: ItemID.densePlateIron, count: 1}] },
		{ source: {id: ItemID.plateGold, count: 9}, result: [{id: ItemID.densePlateGold, count: 1}] },
		{ source: {id: ItemID.plateTin, count: 9}, result: [{id: ItemID.densePlateTin, count: 1}] },
		{ source: {id: ItemID.plateCopper, count: 9}, result: [{id: ItemID.densePlateCopper, count: 1}] },
		{ source: {id: ItemID.plateBronze, count: 9}, result: [{id: ItemID.densePlateBronze, count: 1}] },
		{ source: {id: ItemID.plateSteel, count: 9}, result: [{id: ItemID.densePlateSteel, count: 1}] },
		{ source: {id: ItemID.plateLead, count: 9}, result: [{id: ItemID.densePlateLead, count: 1}] },
		{ source: {id: ItemID.plateSilver, count: 9}, result: [{id: ItemID.densePlateSilver, count: 1}] },

		// Compact
		{ source: {id: VanillaItemID.redstone, count: 9}, result: [{id: 152, count: 1}] },
		{ source: {id: VanillaItemID.lapis_lazuli, count: 9}, result: [{id: 22, count: 1}] },
		{ source: {id: VanillaItemID.coal, count: 9}, result: [{id: VanillaBlockID.coal_block, count: 1}] },
		{ source: {id: VanillaItemID.diamond, count: 9}, result: [{id: 57, count: 1}] },
		{ source: {id: VanillaItemID.emerald, count: 9}, result: [{id: 133, count: 1}] },
		{ source: {id: VanillaItemID.iron_ingot, count: 9}, result: [{id: 42, count: 1}] },
		{ source: {id: VanillaItemID.gold_ingot, count: 9}, result: [{id: 41, count: 1}] },
		{ source: {id: VanillaItemID.netherite_ingot, count: 9}, result: [{id: VanillaBlockID.netherite_block, count: 1}] },
		{ source: {id: ItemID.ingotCopper, count: 9}, result: [{id: BlockID.blockCopper, count: 1}] },
		{ source: {id: ItemID.ingotTin, count: 9}, result: [{id: BlockID.blockTin, count: 1}] },
		{ source: {id: ItemID.ingotLead, count: 9}, result: [{id: BlockID.blockLead, count: 1}] },
		{ source: {id: ItemID.ingotSteel, count: 9}, result: [{id: BlockID.blockSteel, count: 1}] },
