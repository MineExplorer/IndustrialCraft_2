...
Translation.addTranslation("tooltip.power_consumption", {en: "Consumption: %s EU/t Max: %s EU/t", ru: "Потребление: %s EU/t, %s EU/t макс.", pt: "Consumo: %s EU/t Máx: %s EU/t", zh: "消耗: %s EU/t 最大: %s EU/t"});
